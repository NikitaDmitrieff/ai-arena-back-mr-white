...
def print_tournament_results(tournament_data: Dict[str, any]) -> None:
    ...
    print(
        f"Citizens Wins: {summary['citizens_wins']} ({summary['citizens_wins']/summary['total_games']*100:.1f}%)"
    )
    print(
        f"Mister White Wins: {summary['mister_white_wins']} ({summary['mister_white_wins']/summary['total_games']*100:.1f}%)"
    )
